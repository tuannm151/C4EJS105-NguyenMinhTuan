...
setup = function() {
	...
	let edgesNumber = prompt('Enter the number of edges:')
	for(var i = 0; i < edgesNumber; i++){
		turtle.forward(600/edgesNumber); // keep the shapes not over size if edgesNumber is big
		turtle.left(360/edgesNumber);
	};
	// End of turtle code ------------------------------------------------------------
};
